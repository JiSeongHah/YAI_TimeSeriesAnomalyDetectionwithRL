...
class Train:
    ...
    def __init__(self, model, dataset, batch_size, epochs, optim=Adam, optim_args={}, loss_func=CrossEntropyLoss(),
                 log_nth=10, save_nth=1, save_prefix='', shuffle=True, validation_size=0.2, num_workers=4,
        ...
        self.train_loader = DataLoader(self.dataset, self.batch_size, False, train_sampler,
    ...
    def train(self):
        ...
        opt = self.optim(self.model.parameters(), **self.optim_args)
